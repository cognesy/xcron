...
from xcron.capabilities.observability_structlog.logging_config import LoggingConfig, load_logging_config
...
def configure_logging(*, environ: Mapping[str, str] | None = None) -> LoggingConfig:
    ...
    config = load_logging_config(environ=environ)
...
def get_logger(
    ...
    *,
    ...
    configure_logging(environ=environ)
