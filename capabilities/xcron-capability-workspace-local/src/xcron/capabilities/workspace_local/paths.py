...
setting composed by the selected settings provider and handed down as a value
through the invocation context — a second reader here would be free to
...
from xcron.capabilities.workspace_local.marker import MARKER_FILENAME
from xcron.capabilities.workspace_local.resolver import MANIFEST_DIR, resolve_xcron_home
from xcron.contracts.domain import NormalizedJob
