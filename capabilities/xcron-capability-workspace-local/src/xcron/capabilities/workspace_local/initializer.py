...
from xcron.capabilities.workspace_local.marker import (
    MARKER_KIND,
    marker_path,
    read_marker,
    write_marker,
)
from xcron.capabilities.workspace_local.paths import xcron_home_layout
from xcron.capabilities.workspace_local.resolver import LEGACY_MANIFEST_DIR
from xcron.capabilities.workspace_local.observability import get_logger, instrument_action

LOGGER = get_logger(__name__)

STARTER_MANIFEST = files("xcron.capabilities.workspace_local.resources").joinpath(
