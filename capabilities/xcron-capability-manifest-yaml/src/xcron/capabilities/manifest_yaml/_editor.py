...
from xcron.contracts import ManifestError, ProjectManifest
from xcron.capabilities.manifest_yaml._loader import LoadedManifestDocument, attach_parsed_manifest, load_project_manifest
import logging
...
class ManifestEditError(ManifestError):
...
def list_manifest_jobs(
    ...
    *,
    ...
    document = load_project_manifest(project_path, schedule_name=schedule_name, manifest_dir=manifest_dir)
...
def add_manifest_job(
    ...
    *,
    ...
    return mutate_manifest(project_path, schedule_name=schedule_name, manifest_dir=manifest_dir, mutation=mutate)
...
def mutate_manifest(
    ...
    *,
    ...
    document = load_project_manifest(
        project_path,
        schedule_name=schedule_name,
        manifest_dir=manifest_dir,
    )
