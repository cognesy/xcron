...
from xcron.contracts import NormalizedJob, OverlapPolicy, RuntimePaths
...
def write_wrapper(rendered: RenderedWrapper) -> Path:
    ...
    rendered.runtime_paths.wrappers_dir.mkdir(parents=True, exist_ok=True)
    rendered.runtime_paths.logs_dir.mkdir(parents=True, exist_ok=True)
    rendered.runtime_paths.locks_dir.mkdir(parents=True, exist_ok=True)
