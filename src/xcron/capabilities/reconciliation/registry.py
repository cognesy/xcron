...
from xcron.capabilities.reconciliation.cron_policy import cron_schedule_errors
from xcron.capabilities.reconciliation.domain import PlanChange, ProjectState
from xcron.domain import NormalizedJob
from xcron.capabilities.reconciliation.adapters.cron import (
    CronInspection,
    apply_cron_plan,
...
def default_scheduler_registry() -> SchedulerRegistry:
    ...
    return SchedulerRegistry((LaunchdSchedulerBackend(), CronSchedulerBackend()))
