...
setting, and settings are composed once by :mod:`xcron.configuration` and
...
from xcron.capabilities.workspace.marker import MARKER_FILENAME
from xcron.capabilities.workspace.resolver import MANIFEST_DIR, resolve_xcron_home
