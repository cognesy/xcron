...
from xcron.domain.models import ProjectManifest, ScheduleKind, SUPPORTED_EVERY_SUFFIXES, resolve_working_dir


CRON_FIELD_PATTERN = re.compile(r"^[0-9A-Za-z*/,\-]+$")
SCHEMA_PACKAGE = "xcron.capabilities.manifest.resources.schemas"
